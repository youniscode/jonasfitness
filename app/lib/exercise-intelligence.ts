...
export const EXERCISE_INTELLIGENCE: Record<string, ExerciseIntelligenceEntry> = {
  ...
  "builtin-incline-dumbbell-press": intel({
    ...
    commonMistakes: ["Shrugging at the top"],    regressions: ["builtin-incline-machine-chest-press", "builtin-machine-chest-press", "builtin-elevated-push-up"], progressions: ["builtin-barbell-bench-press", "builtin-incline-barbell-press"], alternatives: ["builtin-incline-machine-chest-press", "builtin-dumbbell-bench-press", "builtin-machine-chest-press", "builtin-incline-barbell-press"],
  }),
  ...
  "builtin-incline-machine-chest-press": intel({
    ...
    commonMistakes: ["Shrugging"],    regressions: ["builtin-machine-chest-press", "builtin-pec-deck-fly", "builtin-elevated-push-up"], progressions: ["builtin-dumbbell-bench-press", "builtin-barbell-bench-press", "builtin-incline-barbell-press"], alternatives: ["builtin-machine-chest-press", "builtin-pec-deck-fly", "builtin-dumbbell-bench-press"],
  }),
  ...
  "builtin-straight-arm-pulldown": intel({
    ...
    alternatives: ["builtin-machine-pullover", "builtin-lat-pulldown", "builtin-assisted-pull-up", "builtin-dumbbell-pullover"],
  }),
  ...
  "builtin-incline-barbell-press": intel({
    ...
    regressions: ["builtin-incline-machine-chest-press", "builtin-machine-chest-press", "builtin-incline-dumbbell-press"], progressions: [],
    alternatives: ["builtin-incline-dumbbell-press", "builtin-incline-machine-chest-press", "builtin-machine-chest-press"],
  }),
