...
const copy = {
  fr: {
    ...
    cta: "Obtenir Jonas Fitness Progress",
    priceLine: "Jonas Fitness Progress · 19 € en paiement unique",
    problem: "LE PROBLÈME",
    ...
    faqs: [
      ...
      ["Est-ce un abonnement ?", "Non. Un paiement unique de 19 € pour Jonas Fitness Progress."],
  ...
  en: {
    ...
    cta: "Get Jonas Fitness Progress",
    priceLine: "Jonas Fitness Progress · €19 one-time",
    problem: "THE PROBLEM",
    ...
    faqs: [
      ...
      ["Is this a subscription?", "No. A one-time €19 purchase of Jonas Fitness Progress."],
  ...
  ar: {
    ...
    cta: "احصل على Jonas Fitness Progress",
    priceLine: "Jonas Fitness Progress · 19 € دفعة واحدة",
    problem: "المشكلة",
    ...
    faqs: [
      ...
      ["هل هو اشتراك؟", "لا. دفعة واحدة بقيمة 19 € مقابل Jonas Fitness Progress."],
