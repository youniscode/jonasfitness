...
const copy = {
  fr: {
    kicker: "LÉGAL",
    title: "Légal",
    intro: "Cette section présente les documents juridiques et de consommation qui régissent l’achat et l’utilisation de Jonas Progress (« Progress »), un carnet d’entraînement numérique de force/musculation auto-dirigé proposé au prix unique de 19 € (accès à Progress).",
    documents: [
    ...
    sellerBody: "Jonas Progress est la marque/le produit. Le vendeur / exploitant légal est Younis MOHAMMAD, entrepreneur individuel. Riviera With Younis est une dénomination commerciale existante de la même entreprise individuelle ; il ne s’agit pas d’une société distincte. L’activité numérique/logicielle supplémentaire est exercée dans le cadre de cette EI existante.",
    ...
    hostingValue: "Vercel, hébergement et déploiement de https://jonasprogress.com.",
    ...
    note: "Remarque : lorsque Stripe Managed Payments est utilisé, Stripe/Link agissent en qualité de commerçant de référence (merchant of record) pour la transaction de paiement. Les conditions de la transaction s’appliquent entre vous et Stripe/Link en tant qu’intermédiaire de paiement ; les conditions de Jonas Progress ci-dessous décrivent le produit logiciel et le support que nous fournissons. Cela ne supprime pas nos propres obligations de support produit, de confidentialité, d’information du consommateur ou de protection des données.",
  },
  en: {
    kicker: "LEGAL",
    title: "Legal",
    intro: "This section lists the legal and consumer documents that govern the purchase and use of Jonas Progress (“Progress”), a self-directed strength/bodybuilding training log offered as a €19 one-time access.",
    documents: [
    ...
    adminRegistration: "Additional-activity registration (French Guichet unique / RNE): the additional digital/software activity under the existing individual enterprise is pending administrative registration/update through the French Guichet unique / RNE and is <strong>not yet completed</strong>.",
    ...
    note: "Note: where Stripe Managed Payments is used, Stripe/Link act as merchant of record for the payment transaction. The transaction terms apply between you and Stripe/Link as the payment intermediary; Jonas Progress’s own terms below describe the software product and support we provide. This does not remove our own product-support, privacy, consumer-information, or data-protection obligations.",
  },
  ar: {
    kicker: "قانوني",
    title: "قانوني",
    intro: "يعرض هذا القسم المستندات القانونية والمتعلقة بحقوق المستهلك التي تنظم شراء واستخدام Jonas Progress («بروغريس»)، سجل تدريب ذاتي التوجيه للقوة وكمال الأجسام يُقدَّم مقابل وصول إلى Progress لمرة واحدة بقيمة 19 €.",
    documents: [
    ...
    sellerBody: "Jonas Progress هي العلامة التجارية/المنتج. البائع / المشغِّل القانوني هو Younis MOHAMMAD، رائد أعمال فردي (entrepreneur individuel). Riviera With Younis هي تسمية تجارية قائمة لنفس المؤسسة الفردية؛ وهي ليست شركة منفصلة. يُمارَس النشاط الإضافي الرقمي/البرمجي ضمن هذه المؤسسة الفردية القائمة.",
    ...
    hostingValue: "Vercel، استضافة ونشر https://jonasprogress.com.",
    ...
    adminRegistration: "تسجيل النشاط الإضافي (الشباك الموحد / السجل الوطني للمنشآت RNE): النشاط الإضافي الرقمي/البرمجي المُمارَس ضمن المؤسسة الفردية القائمة يتطلب تحديثًا إداريًا عبر الشباك الموحد / السجل الوطني للمنشآت RNE، ولم يُكتمل بعد.",
    ...
    note: "ملاحظة: عند استخدام Stripe Managed Payments، يعمل Stripe/Link بصفتهما التاجر المسجَّل (merchant of record) لمعاملة الدفع. تنطبق شروط المعاملة بينك وبين Stripe/Link بصفتهما وسيط الدفع؛ وتصف شروط Jonas Progress أدناه المنتج البرمجي والدعم الذي نقدمه. لا يُلغي هذا التزاماتنا الخاصة بدعم المنتج والخصوصية وإعلام المستهلك وحماية البيانات.",
  },
} as const;
