...
const copy = {
  fr: {
    ...
    intro: "Les présentes conditions régissent le produit logiciel Jonas Fitness Progress (« Progress ») et l’achat unique de l’accès à Progress.",
  ...
  en: {
    kicker: "TERMS",
    title: "Terms of use",
    intro: "These terms govern the Jonas Fitness Progress (“Progress”) software product and the one-time purchase of Progress access.",
  ...
  ar: {
    ...
    intro: "تنظم هذه الشروط المنتج البرمجي Jonas Fitness Progress («بروغريس») وشراء الوصول إلى Progress لمرة واحدة.",
