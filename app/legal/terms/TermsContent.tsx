...
const copy = {
  fr: {
    ...
    intro: "Les présentes conditions régissent le produit logiciel Jonas Progress (« Progress ») et l’achat unique de l’accès à Progress.",
    ...
    sellerLabel: "Le vendeur / exploitant légal de Jonas Progress est :",
    sellerBody: "Jonas Progress est la marque/le produit ; le vendeur / exploitant légal est Younis MOHAMMAD, entrepreneur individuel. Riviera With Younis est une dénomination commerciale existante de la même entreprise individuelle. L’activité supplémentaire est exercée dans le cadre de cette EI existante.",
    items: [
      ...
      "Enregistrement d’activité supplémentaire (Guichet unique / RNE) : l’activité numérique/logicielle supplémentaire exercée dans le cadre de l’entreprise individuelle existante fait l’objet d’une mise à jour administrative à effectuer via le Guichet unique / RNE ; elle n’est <strong>pas encore aboutie</strong>.",
    ...
    acceptanceText: "En achetant l’accès à Progress ou en utilisant le produit, vous acceptez les présentes conditions. Celles-ci n’excluent pas les droits impératifs dont vous bénéficiez en tant que consommateur.",
  },
  en: {
    kicker: "TERMS",
    title: "Terms of use",
    intro: "These terms govern the Jonas Progress (“Progress”) software product and the one-time purchase of Progress access.",
    ...
    founding: "Progress access",
    foundingText: "Progress is offered as a <strong>one-time access</strong> (currently €19). Founding customers receive access to the current Progress product. Future, optional products or services may be sold separately. This is not a subscription (no recurring billing).",
    positioning: "Seller & payment positioning",
    positioningText: "Where Stripe Managed Payments is enabled (merchant of record for the payment transaction), Stripe/Link act as the payment intermediary for that transaction and process payment data under their own terms and privacy policy. Our terms govern the Jonas Progress <em>product and support</em>; they do not claim that Jonas Progress collects/remits VAT for Managed Payments transactions, and they do not claim Managed Payments removes our own legal, privacy, product-support, consumer-information, or data-protection obligations.",
    ...
    sellerLabel: "The legal seller / operator of Jonas Progress is:",
    sellerBody: "Jonas Progress is the <strong>product/brand</strong>; the legal seller / operator is Younis MOHAMMAD, entrepreneur individuel. Riviera With Younis is an existing commercial name of the same enterprise individuelle. The additional activity is exercised within this existing EI.",
    items: [
      ...
      "Additional-activity registration (French Guichet unique / RNE): the additional digital/software activity under the existing individual enterprise is pending administrative registration/update through the French Guichet unique / RNE and is <strong>not yet completed</strong>.",
    ...
    acceptanceText: "By purchasing Progress access or using the product, you accept these terms. These terms do not exclude the mandatory rights you have under consumer law.",
  },
  ar: {
    kicker: "الشروط",
    title: "شروط الاستخدام",
    intro: "تنظم هذه الشروط المنتج البرمجي Jonas Progress («بروغريس») وشراء الوصول إلى Progress لمرة واحدة.",
    ...
    founding: "الوصول إلى Progress",
    foundingText: "يُقدَّم Progress كـ<strong>وصول لمرة واحدة</strong> (حاليًا 19 €). يحصل العملاء المؤسسون على الوصول إلى منتج Progress الحالي. قد تُباع منتجات أو خدمات مستقبلية اختيارية بشكل منفصل. هذا ليس اشتراكًا (لا فوترة متكررة).",
    positioning: "البائع وموقف الدفع",
    positioningText: "عند تفعيل Stripe Managed Payments (التاجر المسجَّل لمعاملة الدفع)، يعمل Stripe/Link كوسيط دفع لتلك المعاملة ويعالجون بيانات الدفع وفق شروطهم وسياسة الخصوصية الخاصة بهم. تحكم شروطنا <em>المنتج والدعم</em> الخاصين بـ Jonas Progress؛ ولا تدّعي أن Jonas Progress يتحصل/يحوّل ضريبة القيمة المضافة لمعاملات Managed Payments، ولا تدّعي أن Managed Payments يلغي التزاماتنا القانونية وبالخصوصية ودعم المنتج وإعلام المستهلك وحماية البيانات.",
    ...
    sellerLabel: "البائع / المشغِّل القانوني لمنتج Jonas Progress هو:",
    sellerBody: "Jonas Progress هي العلامة التجارية/المنتج؛ البائع / المشغِّل القانوني هو Younis MOHAMMAD، رائد أعمال فردي (entrepreneur individuel). Riviera With Younis هي تسمية تجارية قائمة لنفس المؤسسة الفردية. يُمارَس النشاط الإضافي ضمن هذه المؤسسة الفردية القائمة.",
    items: [
      ...
      "تسجيل النشاط الإضافي (الشباك الموحد / السجل الوطني للمنشآت RNE): النشاط الإضافي الرقمي/البرمجي المُمارَس ضمن المؤسسة الفردية القائمة يتطلب تحديثًا إداريًا عبر الشباك الموحد / السجل الوطني للمنشآت RNE، ولم يُكتمل بعد.",
    ...
    acceptanceText: "بشرائك الوصول إلى Progress أو استخدامك المنتج، فإنك تقبل هذه الشروط. لا تستبعد هذه الشروط الحقوق الملزمة التي تتمتع بها بموجب قانون المستهلك.",
  },
} as const;
